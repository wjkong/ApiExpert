/*property
    Countries, append, attr, each, empty, html, n, s, v, val
*/
var countryStates =
{
    "Countries": [
...
$(function () {
    ...
    $("#ddlCountry option:contains(" + country + ")").attr('selected', 'selected');
