<%@ Page Title="Language Translator" Language="C#" MasterPageFile="~/MyDemo.Master" AutoEventWireup="true" CodeBehind="language-translator.aspx.cs" Inherits="MyDemo.Tool.language_translator" %>
...
<div class=row>
    ...
    <div class ="col-sm-12">
        <textarea id="txtWords" class="form-control" placeholder="Enter your words..." rows=6></textarea>
    </div>
</div>
<br />
...
<input type=hidden id=hidActiveMenu value="hypTool" />
 ...
 <script src="../Scripts/LanguageTranslator.js" type="text/javascript"></script>
</asp:Content>
